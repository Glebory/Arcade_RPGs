...
class SceneForestFour(scene.Scene):
    def __init__(self):
        ...
        self._objects = []
        self._locations = {"river":"fast running river, things might get caught on the river bank"}
        self._loot = {"river" : e.frog, "river bank": scene.generate([ci.necklace, ci.rock], [1, 1])}
        self._npcs = {}
        self._enemy=e.boar 
...
class SceneForestSeven(scene.Scene):
    def __init__(self):
        super().__init__()
        self._name = "forest7"
        self._description = "You follow the river north and soon see a single hut and a <a href='fisherman'>fisherman</a> fishing with"\
                            " his <a href='son'>son</a> from their makeshift dock.<br>You can return <a href='south'>South</a><br>"
        self._exits["north"] = ""
        ...
        self._objects = []
        self._locations = {"hut":"Solidly built wood cabin"}
        self._npcs = {"fisherman":npc.fisherman, "son":npc.fishermans_son}
        self._enemy=None
        self._loot = {"hut":ci.mana_potion}

class SceneForestEight(scene.Scene):
    def __init__(self):
        super().__init__()
        self._name = "forest8"
        self._description = "You continue north and see nothing of notice until you come across the dead body of a deer. <br>"\
...
class SceneForestNine(scene.Scene):
    def __init__(self):
        ...
        self._description = "You follow the path north.<br>"\
                            "Eventually you arrive at the bottom of a cliff face which appears impassable.<br>"\
        ...
        self._objects = []
        self._locations = {"vines: Behind the vines you find a small den, used by smugglers. Inside you can see a crate, chest and a barrel"}
        self._npcs = {}
...
class SceneForestTen(scene.Scene):
    def __init__(self):
        ...
        self._description = "After following the animal tracks for a mile or so you can make out the shape of a hut."\
                            " The faint flicker of firelight is visible through the broken door.<br>You can return <a href='south'>South</a><br>"
        self._exits["north"] = ""
