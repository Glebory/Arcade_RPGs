        ...
        while game_loop:
            ...
            if self._tilemap._level == 2:
                ...
                if self._tilemap._player1.health > 0:
                    ...
                    self._tilemap._player1._screen_scroll = self._tilemap._player1.move(self._tilemap._items, self._tilemap._water, self._tilemap._respawnpt, self._tilemap._coffin, self._tilemap._map)
                    self._tilemap._player1._wallpaper_scroll -= self._tilemap._player1._screen_scroll
